...
%To compare two galaxies by a series of  Lorentz-type transformations we note that \emph{locally}  any manifold has an inertial frame structure, with associated Minkowski metric $\eta_{\alpha \beta}$. 
